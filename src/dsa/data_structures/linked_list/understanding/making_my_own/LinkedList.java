package dsa.data_structures.linked_list.understanding.making_my_own;
...
public class LinkedList<E> implements List<E> {
    ...
    @Override
    @Display // displays the linked list from the given index
    ...
    @Override
    @Converting// converts the list to a formated string
    ...
    @Override
    @Converting // Converting a LinkedList to an array but from a specified index
    ...
    @Override
    @Converting // Converting a LinkedList to arrayList but from the specified index
